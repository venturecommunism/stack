...
import Chi2016ScheduleDaySessionEntity from
  './../../containers/v2/abstract-schedule-day-session-entity';
...
class Chi2016ScheduleDaySession extends React.Component {
  ...
  renderChair(chair) {
    return chair ? (
      <div className="mdl-grid mdl-grid--no-spacing chi2016-abstract-schedule-day-session-chair">
  ...
  render() {
    ...
    if (session) {
      ...
      const titleClassName = classNames(
        ...
        'chi2016-abstract-schedule-day-session-title',
        type
      );
      const entityRef = (c) => {
        this.entityArea = c;
      ...
      return (
        <div
          className="mdl-cell mdl-cell--12-col chi2016-abstract-schedule-day-session"
          ref={sessionRef}
          id={`${id}-abstract-schedule-day-session`}
        ...
        >
          <div className="mdl-grid mdl-grid--no-spacing">
              ...
              <h2 className="chi2016-schedule-day-session-h2">
                <div className="mdl-grid mdl-grid--no-spacing">
                  <div className="mdl-cell mdl-cell--2-col mdl-cell--2-col-tablet
                    mdl-cell--1-col-phone chi2016-abstract-schedule-day-session-room"
                  >
                    <span className="screen-reader-text">{'Room: '}</span>{room}
                  </div>
                  <div className="mdl-cell mdl-cell--10-col mdl-cell--6-col-tablet
                    mdl-cell--3-col-phone chi2016-abstract-schedule-day-session-title-text"
                  >
            ...
            <div className="mdl-cell mdl-cell--12-col
              chi2016-abstract-schedule-day-session-entities"
              ref={entityRef}
            >
